...
public class Member extends BaseEntity {
    ...
    private Member(String email,String profile,String role,String username,String nickname,String provider){
        this.email = email;
    ...
    /**
     * 회원 생성
     * @param domainMemberDTO
     * @return
     */
    public static Member createMember(DomainMemberDTO domainMemberDTO){
        Member member = new Member(domainMemberDTO.getEmail(), domainMemberDTO.getProfile()
                , domainMemberDTO.getRole(), domainMemberDTO.getUsername(), domainMemberDTO.getNickname()
                , domainMemberDTO.getProvider());
